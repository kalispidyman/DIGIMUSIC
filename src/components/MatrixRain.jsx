...
// Animated blob configuration — simulates studio stage lighting
const BLOBS = [
...
export default function MusicBackground() {
  ...
  useEffect(() => {
    ...
    const draw = (t) => {
      ...
      // Draw each blob drifting on a lissajous-like path
      BLOBS.forEach((b) => {
      ...
      // Subtle noise vignette overlay — darkens edges
